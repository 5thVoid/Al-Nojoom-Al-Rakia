...
describe("CartService", () => {
  ...
  describe("addItem", () => {
    ...
    it("should update quantity if item already exists in cart", async () => {
      ...
      const result = await service.addItem(10, 5, 3);
    ...
    it("should throw error if product not found", async () => {
      ...
      await expect(service.addItem(10, 999, 1)).rejects.toThrow(
        "Product not found"
      );
    });

    it("should throw error if quantity is less than 1", async () => {
      await expect(service.addItem(10, 5, 0)).rejects.toThrow(
  ...
  describe("updateItemQuantity", () => {
    it("should update item quantity", async () => {
      ...
      const result = await service.updateItemQuantity(10, 5, 10);
    ...
    it("should remove item if quantity is 0 or less", async () => {
      ...
      const result = await service.updateItemQuantity(10, 5, 0);
    ...
    it("should throw error if item not found in cart", async () => {
      ...
      await expect(service.updateItemQuantity(10, 999, 5)).rejects.toThrow(
  ...
  describe("removeItem", () => {
    ...
    it("should return false if item not found", async () => {
      ...
      const result = await service.removeItem(10, 999);
  ...
  describe("validateStock", () => {
    it("should return valid true if all items have sufficient stock", async () => {
      const mockCart = { id: 1, userId: 10 };
      const mockItems = [
        { productId: 1, quantity: 2, Product: { name: "GPU" } },
        { productId: 2, quantity: 1, Product: { name: "CPU" } },
      ];
    ...
    it("should return invalid items with insufficient stock", async () => {
      const mockCart = { id: 1, userId: 10 };
      const mockItems = [
        { productId: 1, quantity: 20, Product: { name: "GPU" } },
      ];
